...
function Page(){
    ...
    <div className="div_contenedor">
      <div className="div_main">
        ...
        <h1><img src= "https://scontent.fmxl1-1.fna.fbcdn.net/v/t1.15752-9/370267494_837072621230205_6324247251422721537_n.png?_nc_cat=109&ccb=1-7&_nc_sid=8cd0a2&_nc_ohc=HPhy4cZPSEoAX8luwRQ&_nc_ht=scontent.fmxl1-1.fna&oh=03_AdTpgFftJ54j2YJrLPMzjqI2W5A14y3p1bsw1bo8Cd_dCQ&oe=654EF6E9" alt="Descripción de la imagen"     style={{ width: '500px', height: '25px' }} /></h1>
