...
function Page(){
    ...
    return(
        ...
        <div className="div_main">
          ...
          <h1><img src= "https://scontent.fmxl1-1.fna.fbcdn.net/v/t1.15752-9/387646578_3497084270540585_8834031959612378073_n.png?_nc_cat=103&ccb=1-7&_nc_sid=8cd0a2&_nc_ohc=bi0SqvqjVkUAX9RAMWU&_nc_ht=scontent.fmxl1-1.fna&oh=03_AdQMU5s8phEPmjopAXpMhrRw9lokdE3Uy0NSRqpyE7xIUw&oe=654F1FFB" alt="Descripción de la imagen"     style={{ width: '700px', height: '25px' }} /></h1>
